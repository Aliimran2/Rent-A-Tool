...
interface ToolHistoryDao {
    ...
    @Insert
    suspend fun insertToolHistory(toolHistoryEntity: ToolHistoryEntity)
    ...
    """)
    fun getToolHistoryForCustomer(customerId: Long): LiveData<List<ToolHistoryEntity>>
    ...
    @Query("""
        ...
        ORDER BY timestamp DESC
    """)
    fun getToolHistoryForTool(toolId: Long): LiveData<List<ToolHistoryEntity>>

    // Get all tool history
    @Query("SELECT * FROM tool_history ORDER BY timestamp DESC")
    fun getAllToolHistory(): LiveData<List<ToolHistoryEntity>>
    ...
    @Query("""
        ...
        ORDER BY timestamp DESC
    """)
    fun getHistoryByAction(actionType: String): LiveData<List<ToolHistoryEntity>>
    ...
    @Query("""
        ...
        ORDER BY timestamp DESC
    """)
    fun getHistoryByDateRange(startDate: Long, endDate: Long): LiveData<List<ToolHistoryEntity>>
}
