    ...
    companion object {
        ...
        private fun insertInitialData(context: Context) {
            ...
            val customers = listOf(
                Customer( customerName = "M Akram", cnicNumber = "123456789", customerPhone = "555-1234", constructionPlace = "Site A", contractorName = "Alice", contractorPhone = "555-9876", ownerName = "Bob", ownerPhone = "555-1122"),
                Customer( customerName = "Amjid Khan", cnicNumber = "234567890", customerPhone = "555-2345", constructionPlace = "Site B", contractorName = "Charlie", contractorPhone = "555-8765", ownerName = "Dave", ownerPhone = "555-2233"),
                Customer( customerName = "Hafiz Kareem", cnicNumber = "345678901", customerPhone = "555-3456", constructionPlace = "Site C", contractorName = "Eve", contractorPhone = "555-7654", ownerName = "Frank", ownerPhone = "555-3344"),
                Customer( customerName = "Boota", cnicNumber = "456789012", customerPhone = "555-4567", constructionPlace = "Site D", contractorName = "George", contractorPhone = "555-6543", ownerName = "Hannah", ownerPhone = "555-4455"),
                Customer( customerName = "Latif", cnicNumber = "567890123", customerPhone = "555-5678", constructionPlace = "Site E", contractorName = "Ivy", contractorPhone = "555-5432", ownerName = "Jack", ownerPhone = "555-5566")
            )
